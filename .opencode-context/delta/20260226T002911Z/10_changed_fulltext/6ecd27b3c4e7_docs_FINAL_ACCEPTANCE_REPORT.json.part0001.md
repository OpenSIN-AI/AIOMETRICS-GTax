...
```text
{
  ...
  "contractSync": {
    "version": "2026.1",
    "timestamp": "2026-02-25T22:45:55.440Z",
    "scopeYears": [
      "2000",
      "2004",
      "2016",
      ...
      "gateC": {
        ...
        "formulaChecks": [
          ...
          },
          {
            ...
            "actualFormula": "=IFERROR(SUM(FILTER(Buchhaltung_DB!Q2:Q; Buchhaltung_DB!E2:E=\"Ausgabe\"; IFERROR(YEAR(DATEVALUE(Buchhaltung_DB!J2:J));0)=$B$2; REGEXMATCH(Buchhaltung_DB!L2:L;\"(?
```
