...
- source_path: search_and_upload_composio.py
- source_sha256: 756282a192633a338b59ce4cbd42e198996cdf721410ea778f8a62dfd68afebc
- chunk: 1/1
...
# Composio config
COMPOSIO_API_KEY = [REDACTED], "").strip()
...
def execute_action(action, params, account_id):
    ...
    resp = requests.post(url, headers={"x-api-key": [REDACTED]
...
def main():
    if not COMPOSIO_API_KEY: [REDACTED]
