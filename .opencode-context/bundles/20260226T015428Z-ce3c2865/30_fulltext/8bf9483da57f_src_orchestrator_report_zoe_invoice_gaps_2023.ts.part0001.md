...
- source_path: src/orchestrator/report_zoe_invoice_gaps_2023.ts
- source_sha256: c231f97cb3ed491327deec784210979de01961847521da1cdd7bae9e8a48a81d
- chunk: 1/1
...
async function main(): Promise<void> {
  ...
  for (const row of candidates) {
    ...
    for (const [k, meta] of orderMeta.entries()) {
      const orderToken = [REDACTED]);
      const customerToken = [REDACTED]);
