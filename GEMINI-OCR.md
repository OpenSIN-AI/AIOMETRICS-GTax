...
```python
# NICHT MACHEN:
client = genai.Client(api_key="YOUR_API_KEY")  # Funktioniert nicht richtig!
```
...
- **Lösung:** Neuen API Key erstellen unter https://aistudio.google.com/app/apikey

### Problem 2: API Key expired
- **Fehler:** 400 INVALID_ARGUMENT - "API key expired"
- **Lösung:** Environment Variable `GEMINI_API_KEY` setzen statt Constructor-Parameter
